...
COMMANDS = [
    ...
    "execute in minecraft:overworld run forceload add 192 0",
    "execute in minecraft:overworld run setblock 192 100 0 minecraft:chest",
    'item replace block 192 100 0 container.0 with minecraft:diamond_pickaxe[minecraft:damage=1000,minecraft:damage_resistant={types:"#sae:repair_marker"}]',
    "item modify block 192 100 0 container.0 sae:repair/tool",
    "data get block 192 100 0 Items[{Slot:0b}]",
    'execute in minecraft:overworld if data block 192 100 0 Items[{Slot:0b,components:{"minecraft:damage":479}}] unless data block 192 100 0 Items[{Slot:0b}].components."minecraft:damage_resistant" run say Material repair durability passed',
...
EXPECTED_MARKERS = [
    ...
    "Material repair durability passed",
