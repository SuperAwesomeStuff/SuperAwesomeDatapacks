...
function sae:enchant/validate/book_candidate/lunge
function sae:enchant/validate/book_candidate/sweeping_edge
function sae:enchant/validate/book_candidate/wind_burst
