...
function sae:enchant/validate/book_candidate/breach
function sae:enchant/validate/book_candidate/piercing
function sae:enchant/validate/book_candidate/power
function sae:enchant/validate/book_candidate/sharpness
