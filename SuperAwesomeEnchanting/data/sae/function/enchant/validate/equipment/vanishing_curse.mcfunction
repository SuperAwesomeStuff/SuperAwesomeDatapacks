execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/vanishing run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:vanishing_curse"
data modify entity @s data.sae.catalyst set value "glass"
