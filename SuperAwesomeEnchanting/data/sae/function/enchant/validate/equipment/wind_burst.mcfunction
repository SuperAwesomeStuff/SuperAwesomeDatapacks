execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/mace run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:wind_burst"
