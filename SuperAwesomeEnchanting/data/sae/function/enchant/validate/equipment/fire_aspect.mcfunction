execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/fire_aspect run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:fire_aspect"
