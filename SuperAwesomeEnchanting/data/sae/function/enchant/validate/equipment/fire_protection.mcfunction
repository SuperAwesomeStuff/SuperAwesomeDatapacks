execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/armor run return 0
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:projectile_protection" run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:fire_protection"
data modify entity @s data.sae.catalyst set value "magma_cream"
data modify entity @s data.sae.next set value 4
