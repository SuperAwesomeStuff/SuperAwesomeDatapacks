execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/mining_loot run return 0
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:silk_touch" run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:fortune"
data modify entity @s data.sae.catalyst set value "diamond_block"
