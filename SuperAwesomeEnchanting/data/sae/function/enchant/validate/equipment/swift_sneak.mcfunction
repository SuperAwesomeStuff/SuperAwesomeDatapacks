execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/leg_armor run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:swift_sneak"
data modify entity @s data.sae.catalyst set value "sculk_sensor"
