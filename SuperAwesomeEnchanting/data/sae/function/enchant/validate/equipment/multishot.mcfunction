execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/crossbow run return 0
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:piercing" run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:multishot"
data modify entity @s data.sae.catalyst set value "dispenser"
