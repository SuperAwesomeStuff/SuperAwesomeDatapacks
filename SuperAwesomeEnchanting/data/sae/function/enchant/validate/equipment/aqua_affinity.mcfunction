execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/head_armor run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:aqua_affinity"
data modify entity @s data.sae.catalyst set value "sponge"
