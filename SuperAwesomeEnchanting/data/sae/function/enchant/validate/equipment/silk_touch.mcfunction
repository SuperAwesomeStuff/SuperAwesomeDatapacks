...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:fortune" run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:silk_touch"
data modify entity @s data.sae.catalyst set value "slime_block"
