execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/trident run return 0
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:loyalty" run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:channeling"
data modify entity @s data.sae.catalyst set value "lightning_rod"
data modify entity @s data.sae.next set value 1
