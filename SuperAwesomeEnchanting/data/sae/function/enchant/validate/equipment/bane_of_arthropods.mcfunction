execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/weapon run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:bane_of_arthropods"
data modify entity @s data.sae.catalyst set value "spider_eye"
