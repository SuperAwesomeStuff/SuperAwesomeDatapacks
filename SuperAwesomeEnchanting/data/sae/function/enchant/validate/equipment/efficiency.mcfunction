execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/mining run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:efficiency"
