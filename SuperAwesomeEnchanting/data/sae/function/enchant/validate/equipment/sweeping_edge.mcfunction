execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/sweeping run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:sweeping_edge"
data modify entity @s data.sae.catalyst set value "breeze_rod"
