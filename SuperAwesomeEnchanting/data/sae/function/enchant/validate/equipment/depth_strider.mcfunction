execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/foot_armor run return 0
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:frost_walker" run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:depth_strider"
data modify entity @s data.sae.catalyst set value "nautilus_shell"
