execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/fishing run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:luck_of_the_sea"
data modify entity @s data.sae.catalyst set value "pufferfish"
