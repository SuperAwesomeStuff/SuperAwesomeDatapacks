execute unless items block ~ ~ ~ container.10 #minecraft:enchantable/bow run return 0
...
data modify entity @s data.sae.enchantment set value "minecraft:infinity"
data modify entity @s data.sae.catalyst set value "spectral_arrow"
