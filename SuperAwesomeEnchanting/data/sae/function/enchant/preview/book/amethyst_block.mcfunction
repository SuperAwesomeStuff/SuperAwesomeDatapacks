...
function sae:enchant/preview/book_candidate/breach
function sae:enchant/preview/book_candidate/piercing
function sae:enchant/preview/book_candidate/power
function sae:enchant/preview/book_candidate/sharpness
