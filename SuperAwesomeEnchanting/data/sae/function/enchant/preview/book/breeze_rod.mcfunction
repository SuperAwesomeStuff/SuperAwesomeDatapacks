...
function sae:enchant/preview/book_candidate/lunge
function sae:enchant/preview/book_candidate/sweeping_edge
function sae:enchant/preview/book_candidate/wind_burst
