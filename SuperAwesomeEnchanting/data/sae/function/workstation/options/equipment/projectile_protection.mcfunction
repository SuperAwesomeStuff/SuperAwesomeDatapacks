data modify storage sae:runtime option set value {id:"minecraft:shield",name:{text:"Projectile Protection",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Shield",color:"gray",italic:false}],data:{action:"enchant_option",option:"projectile_protection"}}
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.name set value {text:"Projectile Protection I",color:"aqua",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.name set value {text:"Projectile Protection II",color:"aqua",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.name set value {text:"Projectile Protection III",color:"aqua",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.name set value {text:"Projectile Protection IV",color:"aqua",italic:false}
...
function sae:workstation/inventory/count/shield
