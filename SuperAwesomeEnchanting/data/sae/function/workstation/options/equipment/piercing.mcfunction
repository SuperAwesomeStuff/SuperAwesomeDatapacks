data modify storage sae:runtime option set value {id:"minecraft:amethyst_block",name:{text:"Piercing",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Amethyst Block",color:"gray",italic:false}],data:{action:"enchant_option",option:"piercing"}}
scoreboard players set #available sae.tmp 1
scoreboard players set #current sae.tmp 0
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:piercing"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.name set value {text:"Piercing I",color:"aqua",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.name set value {text:"Piercing II",color:"aqua",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.name set value {text:"Piercing III",color:"aqua",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.name set value {text:"Piercing IV",color:"aqua",italic:false}
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:multishot" run data modify storage sae:runtime option.lore append value {text:"Conflicts with Multishot",color:"red",italic:false}
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:multishot" run scoreboard players set #available sae.tmp 0
