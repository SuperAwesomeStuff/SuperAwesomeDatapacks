data modify storage sae:runtime option set value {id:"minecraft:amethyst_block",name:{text:"Sharpness",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Amethyst Block",color:"gray",italic:false}],data:{action:"enchant_option",option:"sharpness"}}
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.name set value {text:"Sharpness I",color:"aqua",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.name set value {text:"Sharpness II",color:"aqua",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.name set value {text:"Sharpness III",color:"aqua",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.name set value {text:"Sharpness IV",color:"aqua",italic:false}
execute if score #next sae.tmp matches 5 run data modify storage sae:runtime option.name set value {text:"Sharpness V",color:"aqua",italic:false}
