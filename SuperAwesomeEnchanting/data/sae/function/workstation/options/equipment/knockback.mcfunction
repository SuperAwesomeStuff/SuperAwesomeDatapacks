data modify storage sae:runtime option set value {id:"minecraft:piston",name:{text:"Knockback",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Piston",color:"gray",italic:false}],data:{action:"enchant_option",option:"knockback"}}
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.name set value {text:"Knockback I",color:"aqua",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.name set value {text:"Knockback II",color:"aqua",italic:false}
