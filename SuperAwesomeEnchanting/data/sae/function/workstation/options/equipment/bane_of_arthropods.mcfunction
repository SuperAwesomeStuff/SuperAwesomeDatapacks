data modify storage sae:runtime option set value {id:"minecraft:spider_eye",name:{text:"Bane Of Arthropods",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Spider Eye",color:"gray",italic:false}],data:{action:"enchant_option",option:"bane_of_arthropods"}}
scoreboard players set #available sae.tmp 1
scoreboard players set #current sae.tmp 0
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:bane_of_arthropods"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.name set value {text:"Bane Of Arthropods I",color:"aqua",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.name set value {text:"Bane Of Arthropods II",color:"aqua",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.name set value {text:"Bane Of Arthropods III",color:"aqua",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.name set value {text:"Bane Of Arthropods IV",color:"aqua",italic:false}
execute if score #next sae.tmp matches 5 run data modify storage sae:runtime option.name set value {text:"Bane Of Arthropods V",color:"aqua",italic:false}
scoreboard players operation #cost sae.tmp = #next sae.tmp
function sae:workstation/options/add_cost_lore
execute if score #current sae.tmp matches 5.. run data modify storage sae:runtime option.lore append value {text:"Maximum tier reached",color:"red",italic:false}
execute if score #current sae.tmp matches 5.. run scoreboard players set #available sae.tmp 0
...
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:breach" run data modify storage sae:runtime option.lore append value {text:"Conflicts with Breach",color:"red",italic:false}
execute if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:enchantments"."minecraft:breach" run scoreboard players set #available sae.tmp 0
