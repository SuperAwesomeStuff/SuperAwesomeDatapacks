data modify storage sae:runtime option set value {id:"minecraft:soul_sand",name:{text:"Soul Speed",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Soul Sand",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"soul_sand"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:soul_speed"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Soul Speed I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Soul Speed II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Soul Speed III",color:"gray",italic:false}
