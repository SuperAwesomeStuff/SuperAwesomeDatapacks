data modify storage sae:runtime option set value {id:"minecraft:iron_block",name:{text:"Unbreaking",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Iron Block",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"iron_block"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:unbreaking"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Unbreaking I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Unbreaking II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Unbreaking III",color:"gray",italic:false}
