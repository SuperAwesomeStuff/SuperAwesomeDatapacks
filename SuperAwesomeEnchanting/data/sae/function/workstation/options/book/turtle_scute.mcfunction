data modify storage sae:runtime option set value {id:"minecraft:turtle_scute",name:{text:"Respiration",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Turtle Scute",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"turtle_scute"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:respiration"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Respiration I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Respiration II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Respiration III",color:"gray",italic:false}
...
function sae:workstation/inventory/count/turtle_scute
