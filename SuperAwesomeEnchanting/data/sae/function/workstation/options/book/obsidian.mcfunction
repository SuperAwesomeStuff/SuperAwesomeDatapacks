data modify storage sae:runtime option set value {id:"minecraft:obsidian",name:{text:"Blast Protection",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Obsidian",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"obsidian"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:blast_protection"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Blast Protection I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Blast Protection II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Blast Protection III",color:"gray",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.lore append value {text:"Blast Protection IV",color:"gray",italic:false}
