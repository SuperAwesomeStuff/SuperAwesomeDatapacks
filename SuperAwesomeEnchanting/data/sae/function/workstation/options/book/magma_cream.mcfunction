data modify storage sae:runtime option set value {id:"minecraft:magma_cream",name:{text:"Fire Protection",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Magma Cream",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"magma_cream"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:fire_protection"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Fire Protection I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Fire Protection II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Fire Protection III",color:"gray",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.lore append value {text:"Fire Protection IV",color:"gray",italic:false}
