data modify storage sae:runtime option set value {id:"minecraft:pufferfish",name:{text:"Luck Of The Sea",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Pufferfish",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"pufferfish"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:luck_of_the_sea"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Luck Of The Sea I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Luck Of The Sea II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Luck Of The Sea III",color:"gray",italic:false}
...
function sae:workstation/inventory/count/pufferfish
