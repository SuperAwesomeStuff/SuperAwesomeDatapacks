data modify storage sae:runtime option set value {id:"minecraft:blue_ice",name:{text:"Frost Walker",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Blue Ice",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"blue_ice"}}
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Frost Walker I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Frost Walker II",color:"gray",italic:false}
