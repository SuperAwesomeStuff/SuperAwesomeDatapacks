data modify storage sae:runtime option set value {id:"minecraft:diamond_block",name:{text:"Fortune",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Diamond Block",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"diamond_block"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:fortune"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Fortune I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Fortune II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Fortune III",color:"gray",italic:false}
