data modify storage sae:runtime option set value {id:"minecraft:redstone_block",name:{text:"Efficiency, Quick Charge",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Redstone Block",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"redstone_block"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:efficiency"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Efficiency I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Efficiency II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Efficiency III",color:"gray",italic:false}
execute if score #next sae.tmp matches 4 run data modify storage sae:runtime option.lore append value {text:"Efficiency IV",color:"gray",italic:false}
execute if score #next sae.tmp matches 5 run data modify storage sae:runtime option.lore append value {text:"Efficiency V",color:"gray",italic:false}
scoreboard players set #current sae.tmp 0
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:quick_charge"
scoreboard players operation #next sae.tmp = #current sae.tmp
scoreboard players add #next sae.tmp 1
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Quick Charge I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Quick Charge II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Quick Charge III",color:"gray",italic:false}
...
function sae:workstation/inventory/count/redstone_block
