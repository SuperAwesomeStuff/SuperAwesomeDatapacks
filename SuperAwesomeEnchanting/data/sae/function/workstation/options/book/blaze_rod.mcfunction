data modify storage sae:runtime option set value {id:"minecraft:blaze_rod",name:{text:"Fire Aspect, Flame",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Blaze Rod",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"blaze_rod"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:fire_aspect"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Fire Aspect I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Fire Aspect II",color:"gray",italic:false}
scoreboard players set #current sae.tmp 0
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:flame"
scoreboard players operation #next sae.tmp = #current sae.tmp
scoreboard players add #next sae.tmp 1
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Flame I",color:"gray",italic:false}
...
function sae:workstation/inventory/count/blaze_rod
