data modify storage sae:runtime option set value {id:"minecraft:tropical_fish",name:{text:"Lure",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Tropical Fish",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"tropical_fish"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:lure"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Lure I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Lure II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Lure III",color:"gray",italic:false}
...
function sae:workstation/inventory/count/tropical_fish
