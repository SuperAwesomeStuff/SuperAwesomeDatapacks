data modify storage sae:runtime option set value {id:"minecraft:pointed_dripstone",name:{text:"Thorns",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Pointed Dripstone",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"pointed_dripstone"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:thorns"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Thorns I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Thorns II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Thorns III",color:"gray",italic:false}
...
function sae:workstation/inventory/count/pointed_dripstone
