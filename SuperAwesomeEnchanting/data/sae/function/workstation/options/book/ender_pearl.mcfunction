data modify storage sae:runtime option set value {id:"minecraft:ender_pearl",name:{text:"Loyalty",color:"aqua",italic:false},lore:[{text:"Catalyst: 1 × Ender Pearl",color:"gray",italic:false}],data:{action:"enchant_option",book:1b,catalyst:"ender_pearl"}}
...
execute store result score #current sae.tmp run data get block ~ ~ ~ Items[{Slot:10b}].components."minecraft:stored_enchantments"."minecraft:loyalty"
...
execute if score #next sae.tmp matches 1 run data modify storage sae:runtime option.lore append value {text:"Loyalty I",color:"gray",italic:false}
execute if score #next sae.tmp matches 2 run data modify storage sae:runtime option.lore append value {text:"Loyalty II",color:"gray",italic:false}
execute if score #next sae.tmp matches 3 run data modify storage sae:runtime option.lore append value {text:"Loyalty III",color:"gray",italic:false}
