...
execute if data block ~ ~ ~ Items[{Slot:10b}] if score #clock sae.clock matches 0 run function sae:workstation/render
execute if data block ~ ~ ~ Items[{Slot:10b}] if score #clock sae.clock matches 10 run function sae:workstation/render
